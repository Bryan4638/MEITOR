...
public class CardCompra extends javax.swing.JPanel {
    ...
    public CardCompra(RegistroCompra registroCompra) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText(registroCompra.getProveedor().getName());

        jLabel3.setFont(new java.awt.Font("Noto Sans CJK SC Medium", 0, 12)); // NOI18N
        jLabel3.setText("Monto Cobrado: "+ registroCompra.getCompra().calcularValorDeCompra()+" $");

        jLabel4.setFont(new java.awt.Font("Noto Sans CJK SC Medium", 0, 12)); // NOI18N
        jLabel4.setText("Cantidad de Artículos: "+ registroCompra.getCompra().getArticulos().size());

        jLabel5.setFont(new java.awt.Font("Noto Sans CJK SC Medium", 0, 12)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText(String.valueOf(registroCompra.getFecha()));

        jLabel6.setFont(new java.awt.Font("Noto Sans CJK SC Medium", 0, 12)); // NOI18N
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText(String.valueOf(registroCompra.getHora()));
