...
public class AddEmpleado extends javax.swing.JPanel {
    ...
    private void buttonAddActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Empleado empleado = new Empleado(name, email, edad, areaDeTrabajo, tiempoDeTrabajo, sueldo);
        new BaseDatos().guardarDatos(empleado);
        JOptionPane.showMessageDialog(this, "Empleado Contratado con Exito");
        textName.setText("");
        textEmail.setText("");
        textEdad.setText("");
        textAreaDeTrabajo.setText("");
