...
public class CardJefe extends javax.swing.JPanel {

    private Jefe jefe;
    private JPanel panel;
    public CardJefe(Jefe jefe, JPanel panel) {
        this.jefe=jefe;
        this.panel=panel;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText(jefe.getName());

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText(jefe.getCargo());

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText(jefe.getSueldo()+" $");

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText(jefe.getTiempoDeTrabajo());
    ...
    private void buttonEditActionPerformed(java.awt.event.ActionEvent evt) {
        JefeEdit jefeEdit = new JefeEdit(jefe);
        jefeEdit.setSize(913, 510);
        jefeEdit.setLocation(0,0);

        panel.removeAll();
        panel.add(jefeEdit, BorderLayout.CENTER);
        panel.revalidate();
        panel.repaint();
    }

    private void buttonDespedirActionPerformed(java.awt.event.ActionEvent evt) {
        new Empresa().despedirJefes(jefe);
